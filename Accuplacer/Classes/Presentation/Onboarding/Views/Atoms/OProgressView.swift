...
private extension OProgressView {
    func createCircularPath() {
        ...
        circleLayer.strokeColor = UIColor(integralRed: 198, green: 54, blue: 136, alpha: 0.3).cgColor
        ...
        progressLayer.strokeColor = UIColor(integralRed: 198, green: 54, blue: 136).cgColor
