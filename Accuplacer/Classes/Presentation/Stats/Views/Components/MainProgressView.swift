...
class MainProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        drawProgress(for: bigProgress, multiplerSize: 1, color: UIColor(integralRed: 120, green: 55, blue: 244))
        drawProgress(for: mediumProgress, multiplerSize: 0.8, color: UIColor(integralRed: 198, green: 54, blue: 136))
        drawProgress(for: smallProgress, multiplerSize: 0.6, color: UIColor(integralRed: 244, green: 169, blue: 67))
    }
}
